...
The portable suite was run on this repository's files on 15 September 2026 with Node.js 24.19.0. The command `node tools/check-demo.mjs` passed 377 of 377 tests, twice, with the same test names both times. The public copy of 14 September 2026 passed 162 of 162 with the same command, and the 215 tests added since cover the live Sepolia path.
